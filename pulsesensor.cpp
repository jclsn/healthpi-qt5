...
void get_pulse(){     //int sig_num){
    ...
    if (pulse_signal < threshold && N > ibi_threefifth) {     	// Avoid dichroitic noise by waiting 3/5 of last IBI (inter-beat interval)
